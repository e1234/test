(function(e) {
    ...
    t.directive("chosen", function() {
        ...
        n = function(t, n, i) {
            var s = parseInt(i.maxSelection, 10),
                o = parseInt(i.searchThreshold, 10);
            ...
            n.chosen({
                width: "100%",
                max_selected_options: s,
                disable_search_threshold: o,
                search_contains: true
            });
            n.on("change", function() {
                n.trigger("chosen:updated")
            });
            t.$watchGroup(r, function() {
                setTimeout(function() {
                    n.trigger("chosen:updated")
                }, 100)
            });
